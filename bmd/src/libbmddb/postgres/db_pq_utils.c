...
{
	printf("postgres_bmd_db_connect_get_db_type\n");
...
{
	printf("postgres_bmd_db_get_max_entry\n");
...
{
	printf("postgres_bmd_db_get_actualtime_sql\n");
	char *TimeNow = NULL;
...
{
	printf("postgres_bmd_db_get_sequence_nextval\n");
...
{
	printf("postgres_bmd_db_get_sequence_currval\n");
...
{
	printf("postgres_bmd_db_escape_string\n");
...
{
	printf("postgres_bmd_db_date_to_timestamp\n");
...
{
	printf("postgres_bmd_db_add_bind_var\n");
...
long postgres_bmd_db_add_bind_var_long(long var,const char *var_type,void *hDB,char **bind_sql_str,
							  char ***bv,long *bc)
{
	printf("postgres_bmd_db_add_bind_var_long\n");
...
{
	printf("postgres_bmd_db_generate_order_clause\n");
...
long postgres_bmd_db_paginate_sql_query(	char *sql_begin,
						...
						char **sql_limits)
{
	printf("postgres_bmd_db_paginate_sql_query\n");
