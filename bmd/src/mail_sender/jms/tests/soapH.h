...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__put(struct soap*, struct ns1__put *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__put(struct soap*, const struct ns1__put *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__put(struct soap*, const struct ns1__put *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__put(struct soap*, const char*, int, const struct ns1__put *, const char*);
SOAP_FMAC3 struct ns1__put * SOAP_FMAC4 soap_get_ns1__put(struct soap*, struct ns1__put *, const char*, const char*);
SOAP_FMAC3 struct ns1__put * SOAP_FMAC4 soap_in_ns1__put(struct soap*, const char*, struct ns1__put *, const char*);
SOAP_FMAC5 struct ns1__put * SOAP_FMAC6 soap_new_ns1__put(struct soap*, int);
SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns1__put(struct soap*, struct ns1__put*);
SOAP_FMAC3 struct ns1__put * SOAP_FMAC4 soap_instantiate_ns1__put(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns1__put(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns1__putResponse
#define SOAP_TYPE_ns1__putResponse (8)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__putResponse(struct soap*, struct ns1__putResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__putResponse(struct soap*, const struct ns1__putResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__putResponse(struct soap*, const struct ns1__putResponse *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__putResponse(struct soap*, const char*, int, const struct ns1__putResponse *, const char*);
SOAP_FMAC3 struct ns1__putResponse * SOAP_FMAC4 soap_get_ns1__putResponse(struct soap*, struct ns1__putResponse *, const char*, const char*);
SOAP_FMAC3 struct ns1__putResponse * SOAP_FMAC4 soap_in_ns1__putResponse(struct soap*, const char*, struct ns1__putResponse *, const char*);
SOAP_FMAC5 struct ns1__putResponse * SOAP_FMAC6 soap_new_ns1__putResponse(struct soap*, int);
SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns1__putResponse(struct soap*, struct ns1__putResponse*);
SOAP_FMAC3 struct ns1__putResponse * SOAP_FMAC4 soap_instantiate_ns1__putResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns1__putResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
