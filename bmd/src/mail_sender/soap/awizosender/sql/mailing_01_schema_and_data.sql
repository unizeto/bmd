...
CREATE TABLE mailing_message_senders (
    ...
    smtpaddr character varying,
    smtpport character varying,
    smtpuser character varying,
    smtppassword character varying,
    pfxfile text,
    pfxpin character varying,
    allowimageabsent integer,
    maximagesize character varying,
    csvdir character varying,
    csvseparator character varying,
    awizoaction integer,
    smsapiurl character varying(255),
    smsapierror character varying(50)
);
...
CREATE TABLE raports (
    ...
    composition_time timestamp without time zone NOT NULL DEFAULT now(),
...
CREATE INDEX min_key_index
  ON mailing_email_template
  USING btree
  (messagesenderid);
CREATE INDEX full_key_index
  ON mailing_email_template
  USING btree
  (messagesenderid, name, lang, version);
...
VALUES (now(), 1, 'Rejestracja Biura', 'PL', '1.0', 'Rejestracja Biura', '<?xml version="1.0"?>
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Raport udostepnien', 'PL', '1.0', 'E-mail wysyłany do wystawcy po automatycznym udostępnieniu faktur', '<xsl:stylesheet version = "1.0" encoding="UTF-8" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Rejestracja Wystawcy', 'PL', '1.0', 'Rejestracja Wystawcy', '<?xml version="1.0"?>
<xsl:stylesheet version="1.0"
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Elektroniczne awizo zbiorcze', 'PL', '1.0', 'Elektroniczne awizo zbiorcze', '<?xml version="1.0"?>
<xsl:stylesheet version="1.0"
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Awaryjny Kod Logowania', 'PL', '1.0', 'Awaryjny Kod Logowania', '<?xml version="1.0"?>
<xsl:stylesheet version="1.0"
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Powiadomienie o decyzji w sprawie zmiany danych', 'PL', '1.0', 'Powiadomienie o decyzji w sprawie zmiany danych', '<?xml version="1.0"?>
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Powiadomienie o odrzuceniu biura', 'PL', '1.0', 'Powiadomienie o odrzuceniu wniosku o rejestrację biura', '<?xml version="1.0"?>
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Zaproszenie Biura', 'PL', '1.0', 'Zaproszenie Biura', '<?xml version="1.0"?>
<xsl:stylesheet version="1.0"
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Wycofanie wspolpracy z Biurem', 'PL', '1.0', 'Wycofanie wspolpracy z Biurem', '<?xml version="1.0"?>
<xsl:stylesheet version="1.0"
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
INSERT INTO mailing_email_template(created, messagesenderid, name, lang, version, description, xsltohtml, xsltotext, sign) 
VALUES (now(), 1, 'Raport wycofan', 'PL', '1.0', 'Raport wycofań udostępnień faktur', '<?xml version="1.0"?>
