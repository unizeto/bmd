...
int main(int argc, char *argv[])
{
	...
	/************************************************************************************/
	status = soap_call_ns__awizoDownloadAttachment(&soap, host, NULL, id, &emailAttachment);
	...
	if (status == SOAP_OK) {
	    ...
	    fprintf(stderr, "CREATED :  %s \n", emailAttachment->created);
	    fprintf(stderr, "DELETED :  %s \n", emailAttachment->deleted);
	    fprintf(stderr, "TEMPLATEID : %d \n", emailAttachment->templateid);
	    fprintf(stderr, "MIMETYPE : %s \n", emailAttachment->mimetype);
	    fprintf(stderr, "DISPOSITION : %s \n", emailAttachment->disposition);
