...
int main(int argc, char *argv[])
{
	...
	sender->smtpaddr = "128.0.0.1"; 
	sender->smtpport = "27";
	sender->pfxpin = "tklimek:7";
	sender->awizoaction = 0;
	sender->allowimageabsent = 0;
	...
	sender->smsapierror = "ERROREK";

	/*********************************************************************************/
	 status = soap_call_ns__awizoChangeSenderInfo(&soap, host, NULL, id, sender, &result);
	/*********************************************************************************/
