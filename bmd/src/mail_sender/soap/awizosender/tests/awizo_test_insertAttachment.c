...
int main(int argc, char *argv[])
{
	...
	emailAttachment->templateid = 32;
	emailAttachment->filename = "UniLogo";
	emailAttachment->mimetype = "text/plain";
	emailAttachment->disposition = "attachment";
	
	/****************************************************************************************/
	 status = soap_call_ns__awizoInsertAttachment(&soap, host, NULL, emailAttachment, &result);
	/****************************************************************************************/
