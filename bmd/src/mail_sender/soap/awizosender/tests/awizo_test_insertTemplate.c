...
int main(int argc, char *argv[])
{
	...
	emailTemplate->messagesenderid = 23;
	emailTemplate->name = "Play4Testowy";
	emailTemplate->lang = "PL";
	emailTemplate->version = "1.0";
	emailTemplate->description = "sprawdzam jak dziala wstawianie po soapie";
	emailTemplate->sign = 0;

	/****************************************************************************************/
	 status = soap_call_ns__awizoInsertTemplate(&soap, host, NULL, emailTemplate, &result);
	/****************************************************************************************/
