...
int main(int argc, char *argv[])
{
	...
	struct ns__attachmentComplex *emailAttachment = NULL;
	...
	emailAttachment=(struct ns__attachmentComplex*)calloc(1, sizeof(struct ns__attachmentComplex));
	emailAttachment->templateid = 50;
	emailAttachment->filename = "UniLogo2";
	emailAttachment->mimetype = "text/html";
	emailAttachment->disposition = "attachmencik";
	
	/*************************************************************************************************/
	 status = soap_call_ns__awizoChangeAttachmentInfo(&soap, host, NULL, id, emailAttachment, &result);
	/*************************************************************************************************/
