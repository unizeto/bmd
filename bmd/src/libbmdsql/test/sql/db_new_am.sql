...
CREATE INDEX relation_types_type_index ON relation_types(type);
...
CREATE INDEX co_cases_fk_crypto_objects_index ON co_cases (fk_crypto_objects);
CREATE INDEX co_cases_fk_cases ON co_cases (fk_cases);
/***********************************************************/
/****************************************/
/*	ROLES AND ACTIONS		*/
/****************************************/
...
CREATE INDEX actions_type_index ON actions(type);
