...
#include <bmd/libbmdasn1_common/V2Form.h>
...
static asn_TYPE_tag2member_t asn_MAP_V2Form_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* issuerName at 198 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* baseCertificateID at 199 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* objectDigestInfo at 200 */
};
