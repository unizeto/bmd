...
#include <bmd/libbmdasn1_common/PolicyMappings.h>
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 0, 0, 1 }, /* issuerDomainPolicy at 144 */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 1, -1, 0 } /* subjectDomainPolicy at 145 */
};
