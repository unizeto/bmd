...
static asn_INTEGER_enum_map_t asn_MAP_ServiceType_value2enum_1[] = {
	{ 1,	3,	"cpd" },
	{ 2,	3,	"vsd" },
	{ 3,	4,	"cpkc" },
	{ 4,	4,	"ccpd" }
};
static unsigned int asn_MAP_ServiceType_enum2value_1[] = {
	3,	/* ccpd(4) */
	0,	/* cpd(1) */
	2,	/* cpkc(3) */
	1	/* vsd(2) */
};
static asn_INTEGER_specifics_t asn_SPC_ServiceType_specs_1 = {
