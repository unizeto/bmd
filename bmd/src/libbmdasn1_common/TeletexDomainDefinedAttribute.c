...
#include <bmd/libbmdasn1_common/TeletexDomainDefinedAttribute.h>
...
static asn_TYPE_tag2member_t asn_MAP_TeletexDomainDefinedAttribute_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (20 << 2)), 0, 0, 1 }, /* type at 646 */
    { (ASN_TAG_CLASS_UNIVERSAL | (20 << 2)), 1, -1, 0 } /* value at 648 */
};
