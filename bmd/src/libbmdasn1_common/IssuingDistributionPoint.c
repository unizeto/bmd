...
#include <bmd/libbmdasn1_common/IssuingDistributionPoint.h>
...
static asn_TYPE_tag2member_t asn_MAP_IssuingDistributionPoint_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* distributionPoint at 329 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* onlyContainsUserCerts at 330 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* onlyContainsCACerts at 331 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* onlySomeReasons at 332 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* indirectCRL at 333 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* onlyContainsAttributeCerts at 334 */
};
