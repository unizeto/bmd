...
int i=0;
	...
	classInfo = (struct bmd230__singleClassInfo *)malloc(sizeof(struct bmd230__singleClassInfo));
 	classInfo->className="nowa super klasa";
	...
	/*********************************************************************************/
	/************************ funkcja testowa ****************************************/
	status=soap_call_bmd230__bmdRegisterNewClass(		&soap, host, NULL, base64Cert, NULL, NULL, NULL, classInfo, &result);
	/*********************************************************************************/
	/*********************************************************************************/
	if (status == SOAP_OK)
	{
