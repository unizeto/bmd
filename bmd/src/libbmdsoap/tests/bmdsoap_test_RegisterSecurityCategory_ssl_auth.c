...
int i=0;
	...
	struct bmd230__singleSecCategoryInfo *secCategoryInfo=NULL;

	secCategoryInfo=(struct bmd230__singleSecCategoryInfo *)malloc(sizeof(struct bmd230__singleSecCategoryInfo));

	secCategoryInfo->secCategoryName="Nowa kategoria1";
	secCategoryInfo->secCategoryId=NULL;

	secCategoryInfo->secCategoryParentNames=(struct bmd230__stringList *)malloc(sizeof(struct bmd230__stringList));

	secCategoryInfo->secCategoryParentNames->__size=0;

	secCategoryInfo->secCategoryParentNames->__ptr=(xsd__string *)malloc(sizeof(xsd__string)*secCategoryInfo->secCategoryParentNames->__size);


	secCategoryInfo->secCategoryChildNames=(struct bmd230__stringList *)malloc(sizeof(struct bmd230__stringList));

	secCategoryInfo->secCategoryChildNames->__size=0;

	secCategoryInfo->secCategoryChildNames->__ptr=(xsd__string *)malloc(sizeof(xsd__string)*secCategoryInfo->secCategoryChildNames->__size);;
	...
	/*********************************************************************************/
	/************************ funkcja testowa ****************************************/
	status=soap_call_bmd230__bmdRegisterNewSecurityCategory(		&soap, host, NULL, base64Cert, NULL, NULL, NULL, secCategoryInfo, &result);
	...
	if (status == SOAP_OK)
	{
		...
		/*********************************************************************************/
		/************************ funkcja odpowiedź ****************************************/
		printf("Rejestracja kategorii bezpieczeństwa powiodła się. id: %i\n",result);
