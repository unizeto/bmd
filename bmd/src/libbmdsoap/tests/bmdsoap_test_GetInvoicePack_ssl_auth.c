...
char *getReason		= NULL;
int stream = 0;
const char* parameter = "parameter's value (get invoice  pack)";
	...
	else
	{
		...
		printf("\t-g string\tpowód pobrania\n");
   ...
   switch(stream)
   {
     case 0 :  {
                ...
                status=soap_call_bmd230__getInvoicePack(&soap, host, NULL, accountId, invoiceId, userIndentifier, getReason, base64Cert, NULL, NULL, NULL, nostream, parameter, &fileResponse);
                /*********************************************************************************/
                /*********************************************************************************/
     ...
     case 1 :  {
                 ...
                 status=soap_call_bmd230__getInvoicePack(&soap, host, NULL, accountId, invoiceId, userIndentifier, getReason, base64Cert, NULL, NULL, NULL, stream, parameter, &fileResponse);
