...
int stream = 0;
	...
	else
	{
		...
		printf("\t-cid liczba\tid aktualnej wersji pliku\n");
		printf("\t-aid liczba\tid pobieranej archiwalnej wersji pliku\n");
  ...
  switch(stream)
   {
     case 0 : {
                /*********************************************************************************/
                /************************ funkcja testowa ****************************************/
                 status=soap_call_bmd230__bmdGetArchiveFileVersion(&soap, host, NULL, base64Cert, NULL, NULL, NULL, cid, aid, nostream, &fileResponse);
                /*********************************************************************************/
                /*********************************************************************************/
...
//                    bmd_save_buf(&plik,fileResponse->filename);
     ...
     case 1 : {
                ...
                /*********************************************************************************/
                /************************ funkcja testowa ****************************************/
                 status=soap_call_bmd230__bmdGetArchiveFileVersion(&soap, host, NULL, base64Cert, NULL, NULL, NULL, cid, aid, stream, &fileResponse);
                /*********************************************************************************/
                /*********************************************************************************/
