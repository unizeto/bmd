...
GenBuf_t plik;
int stream = 0;
const char* parameter = "parameter's value (get by id)";
  ...
  switch(stream)
   {
     case 0 : {
                /*********************************************************************************/
                /************************ funkcja testowa ****************************************/
                 status=soap_call_bmd230__bmdGetFileById(&soap, host, NULL, base64Cert, NULL, NULL, NULL, id, nostream, parameter, &fileResponse);
                /*********************************************************************************/
                /*********************************************************************************/
...
//                    bmd_save_buf(&plik,fileResponse->filename);
     ...
     case 1 : {
                ...
                /*********************************************************************************/
                /************************ funkcja testowa ****************************************/
                 status=soap_call_bmd230__bmdGetFileById(&soap, host, NULL, base64Cert, NULL, NULL, NULL,id, stream, parameter, &fileResponse);
                /*********************************************************************************/
                /*********************************************************************************/
