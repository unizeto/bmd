...
int i=0;
	...
	/* informacja o roli */
	/*********************/
	struct bmd230__singleClassInfo *classInfo = NULL;

	classInfo = (struct bmd230__singleRoleInfo *)malloc(sizeof(struct bmd230__singleRoleInfo));
 	classInfo->className="grupa_wsparcia_zmiana";
	...
	/*********************************************************************************/
	/************************ funkcja testowa ****************************************/
	status=soap_call_bmd230__bmdUpdateClass(		&soap, host, NULL, base64Cert, NULL, NULL, NULL, "4", classInfo, &result);
	/*********************************************************************************/
	/*********************************************************************************/
	if (status == SOAP_OK)
	{
