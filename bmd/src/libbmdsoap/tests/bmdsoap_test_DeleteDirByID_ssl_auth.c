...
int i=0;
	...
	else
	{
		...
		printf("\t-p liczba\tid usuwanego katalogu\n");
		printf("-------------------------------------------------------\n");
		return -1;
	}
	...
	status=soap_call_bmd230__bmdDeleteDirByID(&soap, host, NULL, base64Cert, NULL, NULL,NULL, id, &result);
	/*********************************************************************************/
	/*********************************************************************************/
	...
	if (status == SOAP_OK)
	{
		/*********************************************************************************/
		/************************ funkcja odpowiedź ****************************************/
		printf("Katalog został usunięty z archiwum; result %i\n",result);
		/*********************************************************************************/
		/*********************************************************************************/
	}
	else
