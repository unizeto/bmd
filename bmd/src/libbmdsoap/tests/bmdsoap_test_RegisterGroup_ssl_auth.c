...
int i=0;
	...
	if (argc==5)
	{
		for (i=1; i<argc; i++)
		{
			...
			{
				if (argc>i+1) asprintf(&groupName, "%s", argv[i+1]);
			}
		}
	}
	else
	...
	groupInfo->groupChildNames->__ptr=NULL;
...
// 	groupInfo->groupChildIds->__ptr[0]="8";
// 	groupInfo->groupChildIds->__ptr[1]="10";
	...
	/*********************************************************************************/
	/************************ funkcja testowa ****************************************/
	status=soap_call_bmd230__bmdRegisterNewGroup(		&soap, host, NULL, base64Cert, NULL, NULL, NULL, groupInfo, &result);
	/*********************************************************************************/
	/*********************************************************************************/
	if (status == SOAP_OK)
	{
