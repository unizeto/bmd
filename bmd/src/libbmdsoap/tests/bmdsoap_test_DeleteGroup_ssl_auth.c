...
int i=0;
	...
	groupInfo = (struct bmd230__singleRoleInfo *)malloc(sizeof(struct bmd230__singleRoleInfo));
 	groupInfo->groupName=NULL;
 	groupInfo->groupId="3";

	groupInfo->groupParentNames=(struct bmd230__stringList *)malloc(sizeof(struct bmd230__stringList));
	groupInfo->groupParentNames->__size=0;
	groupInfo->groupParentNames->__ptr=(xsd__string *)malloc(sizeof(xsd__string)*groupInfo->groupParentNames->__size);

	groupInfo->groupParentIds=(struct bmd230__stringList *)malloc(sizeof(struct bmd230__stringList));
	groupInfo->groupParentIds->__size=0;
	groupInfo->groupParentIds->__ptr=(xsd__string *)malloc(sizeof(xsd__string)*groupInfo->groupParentIds->__size);

	groupInfo->groupChildNames=(struct bmd230__stringList *)malloc(sizeof(struct bmd230__stringList));
	groupInfo->groupChildNames->__size=0;
	groupInfo->groupChildNames->__ptr=(xsd__string *)malloc(sizeof(xsd__string)*groupInfo->groupChildNames->__size);

	groupInfo->groupChildIds=(struct bmd230__stringList *)malloc(sizeof(struct bmd230__stringList));
	groupInfo->groupChildIds->__size=0;
	groupInfo->groupChildIds->__ptr=(xsd__string *)malloc(sizeof(xsd__string)*groupInfo->groupChildIds->__size);
	...
	/*********************************************************************************/
	/************************ funkcja testowa ****************************************/
	status=soap_call_bmd230__bmdDeleteGroup(		&soap, host, NULL, base64Cert, NULL, NULL, NULL, groupId, &result);
	/*********************************************************************************/
	/*********************************************************************************/
	if (status == SOAP_OK)
	{
		/*********************************************************************************/
		/************************ funkcja odpowiedź ****************************************/
		printf("Usunięcie grupy powiodło się. id: %i\n",result);
