...
int i=0;
	...
	/*********************************************************************************/
	/************************ funkcja testowa ****************************************/
	/*status=soap_call_bmd230__countInvoice(&soap, host, NULL, "a","b","c",base64Cert, &result);*/
	status=soap_call_bmd230__bmdDeleteFileByID(&soap, host, NULL, base64Cert, NULL, NULL, NULL, id, &result);
	/*********************************************************************************/
	/*********************************************************************************/
