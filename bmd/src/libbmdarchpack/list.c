...
int InitList( list_t* const list_tList )
{
...
int InsertToList( list_t* const list_tList, void* const _node )
 {
...
int FindInList( list_t* list_tList, int (*select)(const void* const, const void* const),\
...
int DeleteFromList( list_t* const list_tList, listNode_t* const elem, void (*del)(void*) )
 {
